...
function About() {
  return (
    <div className='bg-black text-gray-400 flex flex-col'>
      <div>
        <h2 className='text-4xl p-5 mt-20 text-center'>About Victoria Cabs</h2>
      </div>
      ...
      <div>
        <h3 className='text-3xl mb-5 text-center'>Our Fleet</h3>
      </div>
      ...
      <div>
        <h3 className='text-3xl mb-5 ml-5 text-center'>Our Chauffeurs</h3>
      </div>
      ...
      <div>
        <h3 className='text-3xl mb-5 ml-5 text-center'>Commitment to Excellence</h3>
      </div>
